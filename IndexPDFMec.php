...
$pdf->Cell(20,5,'No. Lista',1,0,'C',1);
...
$SQL_READ = "SELECT * FROM mecanico WHERE nombreMec LIKE '%".$buscar."%'";
...
$resul1 = mysqli_query($conexion,$SQL_READ);
  ...
  while ($row =mysqli_fetch_array($resul1)){
	...
	$pdf->Cell(20,5, $row['nlista'],1,0, 'C',0);
	$pdf->Cell(40,5, utf8_decode($row['nombreMec']),1,0, 'C',0);
	$pdf->Cell(30,5, $row['fnacimiento'],1,0, 'C',0);
