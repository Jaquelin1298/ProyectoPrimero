    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class='form-horizontal' action='controladorModFotHerra.php' method='post' enctype='multipart/form-data'>

                                <fieldset>
                                  <legend>Datos de Herramientas</legend>
                                   <div class='form-group'>
                                    <div class='col-md-10'>
                                      <input class='form-control'  type='hidden'  name='idHerramienta'  value="<?php echo $idHerramienta;?>" readonly>
                                    </div>
                                    </div>
                                    <div class='form-group'>
