...
<input type="hidden" name="estado" id="estado" value="1">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
      ...
      <h3>Seleccionar PDF</h3>
  <div class="form-group">
    <label for="description">Archivo</label>
    
   
    <a href="Archivos.php?id=<?php echo $_GET["id"];?>" class="btn btn-warning btn-sm">Modificar Lista</a>
...
<?php if(count($archivos)>0):?>
    ...
    <?php foreach($archivos as $d):
    $encontrado = false;
foreach($curso_archivos as $ca){
  if($ca->archivo_id==$d->id){
    $encontrado = true;
    break;
  }
}
  ...
  <div class="checkbox">
    <label>
      <input type="checkbox" name="archivo_<?php echo $d->id; ?>" <?php if($encontrado){ echo "checked"; }?>> <?php echo $d->archivo; ?>
    </label>
  </div>
<?php endforeach; ?>
<?php endif; ?>
